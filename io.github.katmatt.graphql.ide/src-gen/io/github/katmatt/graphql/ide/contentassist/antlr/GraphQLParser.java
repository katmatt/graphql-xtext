...
public class GraphQLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GraphQLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getObjectTypeDefinitionAccess().getGroup_3_3(), "rule__ObjectTypeDefinition__Group_3_3__0");
			...
			builder.put(grammarAccess.getInterfaceDefinitionAccess().getGroup_3_3(), "rule__InterfaceDefinition__Group_3_3__0");
			builder.put(grammarAccess.getInterfaceDefinitionAccess().getGroup_5(), "rule__InterfaceDefinition__Group_5__0");
			builder.put(grammarAccess.getFieldDefinitionAccess().getGroup(), "rule__FieldDefinition__Group__0");
			builder.put(grammarAccess.getFieldDefinitionAccess().getGroup_2(), "rule__FieldDefinition__Group_2__0");
			builder.put(grammarAccess.getUnionTypeDefinitionAccess().getGroup(), "rule__UnionTypeDefinition__Group__0");
			builder.put(grammarAccess.getUnionTypeDefinitionAccess().getGroup_4(), "rule__UnionTypeDefinition__Group_4__0");
			builder.put(grammarAccess.getUnionTypeDefinitionAccess().getGroup_4_3(), "rule__UnionTypeDefinition__Group_4_3__0");
			builder.put(grammarAccess.getEnumTypeDefinitionAccess().getGroup(), "rule__EnumTypeDefinition__Group__0");
			builder.put(grammarAccess.getEnumTypeDefinitionAccess().getGroup_4(), "rule__EnumTypeDefinition__Group_4__0");
			...
			builder.put(grammarAccess.getInputObjectTypeDefinitionAccess().getGroup_4(), "rule__InputObjectTypeDefinition__Group_4__0");
			...
			builder.put(grammarAccess.getDirectiveDefinitionAccess().getGroup_3(), "rule__DirectiveDefinition__Group_3__0");
			builder.put(grammarAccess.getDirectiveDefinitionAccess().getGroup_8(), "rule__DirectiveDefinition__Group_8__0");
			builder.put(grammarAccess.getDirectiveAccess().getGroup(), "rule__Directive__Group__0");
			builder.put(grammarAccess.getDirectiveAccess().getGroup_1(), "rule__Directive__Group_1__0");
			...
			builder.put(grammarAccess.getScalarTypeDefinitionAccess().getDirectivesAssignment_3(), "rule__ScalarTypeDefinition__DirectivesAssignment_3");
			...
			builder.put(grammarAccess.getObjectTypeDefinitionAccess().getImplementsInterfacesAssignment_3_2(), "rule__ObjectTypeDefinition__ImplementsInterfacesAssignment_3_2");
			builder.put(grammarAccess.getObjectTypeDefinitionAccess().getImplementsInterfacesAssignment_3_3_1(), "rule__ObjectTypeDefinition__ImplementsInterfacesAssignment_3_3_1");
			...
			builder.put(grammarAccess.getInterfaceDefinitionAccess().getImplementsInterfacesAssignment_3_2(), "rule__InterfaceDefinition__ImplementsInterfacesAssignment_3_2");
			builder.put(grammarAccess.getInterfaceDefinitionAccess().getImplementsInterfacesAssignment_3_3_1(), "rule__InterfaceDefinition__ImplementsInterfacesAssignment_3_3_1");
			builder.put(grammarAccess.getInterfaceDefinitionAccess().getDirectivesAssignment_4(), "rule__InterfaceDefinition__DirectivesAssignment_4");
			builder.put(grammarAccess.getInterfaceDefinitionAccess().getFieldDefinitionsAssignment_5_1(), "rule__InterfaceDefinition__FieldDefinitionsAssignment_5_1");
			...
			builder.put(grammarAccess.getFieldDefinitionAccess().getArgumentsDefinitionAssignment_2_1(), "rule__FieldDefinition__ArgumentsDefinitionAssignment_2_1");
			...
			builder.put(grammarAccess.getUnionTypeDefinitionAccess().getDirectivesAssignment_3(), "rule__UnionTypeDefinition__DirectivesAssignment_3");
			builder.put(grammarAccess.getUnionTypeDefinitionAccess().getMemberTypesAssignment_4_2(), "rule__UnionTypeDefinition__MemberTypesAssignment_4_2");
			builder.put(grammarAccess.getUnionTypeDefinitionAccess().getMemberTypesAssignment_4_3_1(), "rule__UnionTypeDefinition__MemberTypesAssignment_4_3_1");
			...
			builder.put(grammarAccess.getEnumTypeDefinitionAccess().getDirectivesAssignment_3(), "rule__EnumTypeDefinition__DirectivesAssignment_3");
			builder.put(grammarAccess.getEnumTypeDefinitionAccess().getEnumValuesDefinitionAssignment_4_1(), "rule__EnumTypeDefinition__EnumValuesDefinitionAssignment_4_1");
			...
			builder.put(grammarAccess.getInputObjectTypeDefinitionAccess().getDirectivesAssignment_3(), "rule__InputObjectTypeDefinition__DirectivesAssignment_3");
			builder.put(grammarAccess.getInputObjectTypeDefinitionAccess().getInputFieldsDefinitionAssignment_4_1(), "rule__InputObjectTypeDefinition__InputFieldsDefinitionAssignment_4_1");
			...
			builder.put(grammarAccess.getObjectFieldAccess().getFieldDefinitionAssignment_0(), "rule__ObjectField__FieldDefinitionAssignment_0");
			...
			builder.put(grammarAccess.getDirectiveDefinitionAccess().getArgumentsDefinitionAssignment_3_1(), "rule__DirectiveDefinition__ArgumentsDefinitionAssignment_3_1");
			...
			builder.put(grammarAccess.getDirectiveDefinitionAccess().getDirectiveLocationsAssignment_7(), "rule__DirectiveDefinition__DirectiveLocationsAssignment_7");
			builder.put(grammarAccess.getDirectiveDefinitionAccess().getDirectiveLocationsAssignment_8_1(), "rule__DirectiveDefinition__DirectiveLocationsAssignment_8_1");
			builder.put(grammarAccess.getDirectiveAccess().getDirectiveAssignment_0(), "rule__Directive__DirectiveAssignment_0");
			builder.put(grammarAccess.getDirectiveAccess().getArgumentsAssignment_1_1(), "rule__Directive__ArgumentsAssignment_1_1");
